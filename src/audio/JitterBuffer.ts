...
export class JitterBuffer {
  ...
  private readonly BYTES_PER_TICK = 640; // 320 samples @ 16kHz × 2 bytes (L16 BE for Telnyx)
  ...
  /**
   * Generate comfort noise at -60dBFS (16-bit BE for Telnyx L16)
  ...
  private generateCng(): Buffer {
    ...
    for (let i = 0; i < this.BYTES_PER_TICK; i += 2) {
      // White noise at -60dBFS, 16-bit Big-Endian (Telnyx L16)
